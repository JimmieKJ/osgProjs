...
public:
    ...
    {
        LOSCreationDialog->setWindowTitle(QApplication::translate("LOSCreationDialog", "Line-of-Sight", 0));
        nameLabel->setText(QApplication::translate("LOSCreationDialog", "Name", 0));
        nameBox->setText(QApplication::translate("LOSCreationDialog", "LOS", 0));
        p1GroupBox->setTitle(QApplication::translate("LOSCreationDialog", "Point 1", 0));
        p1TypeCombo->clear();
        p1TypeCombo->insertItems(0, QStringList()
         << QApplication::translate("LOSCreationDialog", "Point", 0)
         << QApplication::translate("LOSCreationDialog", "Annotation", 0)
        );
        p1LonLabel->setText(QApplication::translate("LOSCreationDialog", "Lon", 0));
        p1LatLabel->setText(QApplication::translate("LOSCreationDialog", "Lat", 0));
        p1AltLabel->setText(QApplication::translate("LOSCreationDialog", "Alt", 0));
        p1PointButton->setText(QApplication::translate("LOSCreationDialog", "Get Map Click", 0));
        p1NodeButton->setText(QApplication::translate("LOSCreationDialog", "Center Map", 0));
        p2GroupBox->setTitle(QApplication::translate("LOSCreationDialog", "Point 2", 0));
        p2TypeCombo->clear();
        p2TypeCombo->insertItems(0, QStringList()
         << QApplication::translate("LOSCreationDialog", "Point", 0)
         << QApplication::translate("LOSCreationDialog", "Annotation", 0)
        );
        p2LonLabel->setText(QApplication::translate("LOSCreationDialog", "Lon", 0));
        p2LatLabel->setText(QApplication::translate("LOSCreationDialog", "Lat", 0));
        p2AltLabel->setText(QApplication::translate("LOSCreationDialog", "Alt", 0));
        p2PointButton->setText(QApplication::translate("LOSCreationDialog", "Get Map Click", 0));
        p2NodeButton->setText(QApplication::translate("LOSCreationDialog", "Center Map", 0));
        p2pRelativeCheckBox->setText(QApplication::translate("LOSCreationDialog", "relative altitudes", 0));
        typeTabs->setTabText(typeTabs->indexOf(p2pTab), QApplication::translate("LOSCreationDialog", "Point-to-Point", 0));
        radPointGroupBox->setTitle(QApplication::translate("LOSCreationDialog", "Point", 0));
        radTypeCombo->clear();
        radTypeCombo->insertItems(0, QStringList()
         << QApplication::translate("LOSCreationDialog", "Point", 0)
         << QApplication::translate("LOSCreationDialog", "Annotation", 0)
        );
        radLonLabel->setText(QApplication::translate("LOSCreationDialog", "Lon", 0));
        radLatLabel->setText(QApplication::translate("LOSCreationDialog", "Lat", 0));
        radAltLabel->setText(QApplication::translate("LOSCreationDialog", "Alt", 0));
        radRelativeCheckBox->setText(QApplication::translate("LOSCreationDialog", "relative altitude", 0));
        radPointButton->setText(QApplication::translate("LOSCreationDialog", "Get Map Click", 0));
        radNodeButton->setText(QApplication::translate("LOSCreationDialog", "Center Map", 0));
        radiusLabel->setText(QApplication::translate("LOSCreationDialog", "Radius (m)", 0));
        spokesLabel->setText(QApplication::translate("LOSCreationDialog", "Spokes", 0));
        typeTabs->setTabText(typeTabs->indexOf(radialTab), QApplication::translate("LOSCreationDialog", "Radial", 0));
        depthTestCheckBox->setText(QApplication::translate("LOSCreationDialog", "Enable Depth Test", 0));
        okButton->setText(QApplication::translate("LOSCreationDialog", "OK", 0));
        cancelButton->setText(QApplication::translate("LOSCreationDialog", "Cancel", 0));
    } // retranslateUi
